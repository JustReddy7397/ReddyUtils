...
public class AttributeModifier {
    ...
    public Object getNBT() {
        try {
            ...
            data.getClass().getMethod("setInt", new Class[] {String.class, int.class}).invoke(data, "Operation", this.operation);
            data.getClass().getMethod("setDouble", new Class[] {String.class, double.class}).invoke(data, "Amount", this.amount);
            data.getClass().getMethod("setLong", new Class[] {String.class, long.class}).invoke(data, "UUIDMost", this.uuid.getMostSignificantBits());
            data.getClass().getMethod("setLong", new Class[] {String.class, long.class}).invoke(data, "UUIDLeast", this.uuid.getLeastSignificantBits());
            return data;
