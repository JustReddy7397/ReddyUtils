...
import wiki.justreddy.ga.reddyutils.Version;
...
public class ItemAttributes {
    ...
    public void addModifier(AttributeModifier modifier) {
        if (this.modifiers != null) {
            try {
                this.modifiers.getClass().getMethod("add", ReflectionUtils.getNMSClass("NBTBase")).invoke(this.modifiers, modifier.getNBT());
    ...
    public ItemStack apply(ItemStack item) {
        try {
            Object itemNMS = ReflectionUtils.getCBClass("inventory.CraftItemStack").getMethod("asNMSCopy", ItemStack.class).invoke(null, item);
            ...
            return (ItemStack) ReflectionUtils.getCBClass("inventory.CraftItemStack").getMethod("asBukkitCopy", ReflectionUtils.getNMSClass("ItemStack")).invoke(null, itemNMS);
        } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | SecurityException e) {
            Bukkit.getLogger().info("[ItemAttributeAPI] Incompatible server version! Some methods can't be applied.");
            return null;
        }
    ...
    public void getFromStack(ItemStack item) {
        try {
            ...
            this.modifiers = itemNMSTag.getClass().getMethod("getList", new Class[] {String.class, int.class}).invoke(itemNMSTag, "AttributeModifiers", 10);
    ...
    public String getVersion() {
        return String.valueOf(Version.API_VERSION);
    }
